...
// Терморегуляция
PARAMETER(NEEDED_THERMOREGULATOR_TEMP_C, 25.0)
PARAMETER(THERMOREGULATOR_PID_DIRECTION, NORMAL)  // (NORMAL, REVERSE)
...
// Тайминги
PARAMETER(TOTALLY_LAUNCHED_AT, MINUTES_TO_MILLIS(120))
